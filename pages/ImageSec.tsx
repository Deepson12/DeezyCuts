...
const ImageSec = () => {
  ...
  return (
    <section className=' bg-secondary  mt-[clamp(5rem,10vw,10rem)] text-accent'>
      ...
      <div className=' grid grid-rows-2 grid-cols-2'>
        ...
        <ParallaxImgs src='/img/pic-1 (1).jpg' alt='barber'/>
        </div>
        ...
        <ParallaxImgs src='/img/pic-2 (1).jpg' alt='barber'/>
        </div>
        ...
        <ParallaxImgs src='/img/otdoor (1).jpg' alt='barber'/>
        </div>
